...
$sql = "SELECT * FROM b_isilaniformu WHERE kullanici_id = $userId";
...
<head>
    ...
    height: 100vh;
        ...
        width: auto; /* Buton genişliği otomatik olarak ayarlanacak */
        padding: 12px 20px;
        border: none;
        border-radius: 5px;
        background-color: #007BFF;
        ...
        <?php if ($result->num_rows > 0): ?>
            <ul class="ads">
                <?php while ($row = $result->fetch_assoc()): ?>
                    <li>
                        <h3><?php echo $row['ad']; ?> <?php echo $row['soyad']; ?></h3>

                        <p><strong>Meslek:</strong> <?php echo $row['meslek']; ?></p>
                        <p><strong>Tarih:</strong> <?php echo $row['tarih']; ?></p>
                        <p><strong>Şehir:</strong> <?php echo $row['sehir']; ?></p>
                        
                        <form action="b_ilansil.php" method="POST">
                        ...
                        <br>
                        <form action="bireysel_ilanguncelle.php" method="GET">
                            <input type="hidden" name="id" value="<?php echo $row['B_id']; ?>">
